package geekbrains.ru.translator.constants
...
//        const val DATA_MODEL = "DATA_MODEL"
        ...
        const val SOUND_EXTRA = "SOUND_EXTRA"

        const val BOTTOM_SHEET_FRAGMENT_DIALOG_TAG = "BOTTOM_SHEET_FRAGMENT_DIALOG_TAG_1"
